...
sed -i "s/NAME='replaceme'/NAME='$alias'/" /home/"$username"/jc3mp/"$svalias"/monit/alias.sh
sed -i "s/DIR=/home/'replaceme'/DIR=/home/'$username'/" /home/"$username"/jc3mp/"$svalias"/monit/alias.sh
